...
let win;
const copyright = `Copyright © 2018 - ${new Date().getFullYear()} Sauco`;
    ...
    const template = [{
        ...
        },
        {
            ...
            submenu: [{
                    label: 'Sauco Website',
                    click() {
                        electron.shell.openExternal('https://sauco.io');
                    },
                },
                {
                    label: 'Sauco Explorer',
                    click() {
                        electron.shell.openExternal('https://explorer.sauco.io');
                    },
                },
                /*{
                  label: 'Lisk Forum',
...
if (process.platform === 'darwin') {
    app.setAboutPanelOptions({
        applicationName: 'Sauco Desktop Wallet',
        copyright,
    });
}

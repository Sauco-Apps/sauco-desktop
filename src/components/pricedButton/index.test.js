...
describe('PricedButton', () => {
  ...
  describe('Sufficient funds', () => {
    ...
    it('renders a span saying "Fee: 5 SAUCO"', () => {
      expect(wrapper.find('span').text()).to.be.equal('Fee: 5 SAUCO');
    });
  ...
  describe('Insufficient funds', () => {
    ...
    it('renders a span saying "Insufficient funds for 5 SAUCO fee"', () => {
      expect(wrapper.find('span').text()).to.be.equal('Insufficient funds for 5 SAUCO fee');
    });
